...
details_survive_price = {"shield": 50, "energyshield": 80, "resist": 30, "evasion": 100,"armor": 140}
users_bot = {}
player_list = []
...
def bot_maker(start_sum, player_list):
    for player in player_list:
        ...
        while wallet >= min(details_damage_price.values()):
            ...
            print(f"{string_2:-^82}")
            print("{detail:^^80}".format(detail="Damagedeal details"))
            ...
            if user_choose in users_bot[player].keys():
                print("{string:!^80}".format(string="Yourbot has this detail"))
                continue
            if user_choose in details_damage_price.keys():
                if wallet <details_damage_price[user_choose]:
                    print("{string:!^80}".format(string="Notenough coins"))
                    continue
